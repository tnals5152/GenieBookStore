    ...
    <div class="row">
       <!-- 왼쪽 사이드바 -->
		...
		<div class="card-header py-3">
              <h6 class="m-0 font-weight-bold" style="color: #5F0E1F;">Q&amp;A수정.</h6>
            </div>
            <div class="card-body">
              	...
              	<table style="width: 90%;">
              		<tr>
              			...
              			<th class="color-black" colspan="3">
              				<input type="text" name="qna_title" style="width: 100%;" value="${qnavo.qna_title }">
              			</th>
              		</tr>
              		<tr>
              			...
              			<th class="color-black" style="width: 25%">
              				<label><input type="radio" name="qna_secret" value="0">비밀글</label>&nbsp;
              		...
              		<tr>
              			<th colspan="4" class="center color-black" style="min-height: 300px;">
              				<textarea rows="5" cols="100" name="qna_content">${qnavo.qna_content }</textarea>
              			</th>
              		</tr>
              		<tr>
              			<td colspan="6" class="center">
              				<input type="hidden" name="qna_no" value="${qnavo.qna_no }">
              				<input type="button" class="btn finishbtn" value="수정완료" onclick="writeFinish(this.form)">
...
<script>
	$(function(){
		...
		$("input:radio[name='qna_secret']:radio[value='${qnavo.qna_secret}']").prop('checked', true);
