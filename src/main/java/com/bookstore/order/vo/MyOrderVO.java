...
public class MyOrderVO {
	...
	public MyOrderVO(int order_no, String order_user_id, String order_recv_name, String order_recv_phone, String order_date,
	...
	public String toString() {
		return "MyOrderVO [order_no=" + order_no + ", order_user_id=" + order_user_id + ", order_recv_name="
